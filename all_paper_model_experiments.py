...
def regression_experiment_run():
    ...
    for transformation in transformation_list:
        ...
        X,y = data_mixer(X_random,y_random,X_data,y_data_reg,0.2,0.2)
        ...
        regressors = [dum_reg,rf_reg,lr,mlp_reg]
...
def classification_experiment_run():
    ...
    for transformation in transformation_list:
        ...
        X,y = data_mixer(X_test_cla,y_test_cla,X_data,y_data_clf,0.2,0.2)
        ...
        classifiers = [ dum_clf,rf_clf,svm,mlp_clf]
